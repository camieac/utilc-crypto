...
* @brief Triple DES software implementation.
* -- RULE_3_2_CD_do_not_use_special_characters_in_filename
* -- RULE_8_1_A_provide_file_info_comment
*/

#ifndef UTILC_CRYPTO_TRIPLE_DES_IMPL_H
#define UTILC_CRYPTO_TRIPLE_DES_IMPL_H
...
#endif //UTILC_CRYPTO_TRIPLE_DES_IMPL_H
