...
START_TEST (test_aes_128_ecb_16_encrypt) {
	...
	AES128_ECB_encrypt(plaintext, key, buffer);
...
START_TEST (test_aes_128_ecb_16_decrypt) {
	...
	AES128_ECB_decrypt(ciphertext, key, buffer);
...
START_TEST (test_aes_128_ecb_64_encrypt) {
	...
	AES128_ECB_encrypt_buffer(buffer, plaintext, 64, key);
...
START_TEST (test_aes_128_ecb_64_decrypt) {
	...
	AES128_ECB_decrypt_buffer(buffer, ciphertext, 64, key);
